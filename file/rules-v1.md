...
- 译文应调整结构以符合中文表达习惯，必要时也可重写
	...
	- 译文：`高大无比的红柏树有着魔法的属性。`
- 此前版本的翻译可以作为参考，但如果有错误也可以舍弃。
- 对于那些没有翻译的条目，或者翻译与原文完全一致，请直接复制英文原文
...
- 除非作者在语言文件中专门提供了翻译者署名的地方，否则不应在任何位置添加翻译者署名，特别是作者要求签署 CLA 的情况。你的贡献将会在 Contribution 处彰显。
